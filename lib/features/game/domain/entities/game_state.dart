...
enum GameStatus { idle, running, bossBattle, victory, defeat }
...
class Leo {
  double x; // Posición horizontal (-1.0 es extremo izquierdo, 1.0 es extremo derecho)
  double speedY; // Velocidad de avance vertical

  Leo({
    this.x = 0.0,
    this.speedY = 0.10, // Avance por segundo (0.10 significa 10% del recorrido por segundo)
  });
}
